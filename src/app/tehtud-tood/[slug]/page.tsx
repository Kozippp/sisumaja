            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12">
              {project.stat_views && (
                <div className="bg-neutral-900/50 p-4 rounded-xl border border-neutral-800 text-center">
                  ...
                  <div className="text-xl font-bold text-white">{project.stat_views}</div>
              ...
              {project.stat_comments && (
                <div className="bg-neutral-900/50 p-4 rounded-xl border border-neutral-800 text-center">
                  ...
                  <div className="text-xl font-bold text-white">{project.stat_comments}</div>
              ...
              {project.stat_shares && (
                <div className="bg-neutral-900/50 p-4 rounded-xl border border-neutral-800 text-center">
                  ...
                  <div className="text-xl font-bold text-white">{project.stat_shares}</div>
